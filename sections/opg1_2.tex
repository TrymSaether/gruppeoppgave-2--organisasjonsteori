...
arrangementet. For å analysere disse gruppene benyttes en PESTEL-analyse\cite{Teknologiledelse}(Mangler side).
...
følgende hovedmål: Økonomisk bærekraft, politisk gevinst og Miljømessig bærekraft og troverdighet.
...
i sentrum. For næringslivet var hovedmålet å oppnå økt omsetning, bygge nettverk, og 
styrke Trondheim som en attraktiv destinasjon for fremtidige arrangementer og turisme. (Kilde?)
